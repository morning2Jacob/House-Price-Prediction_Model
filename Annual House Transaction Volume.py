...
plt.savefig('C:\\Users\\Jacob Kai\\Documents\\Python_UniClass\\House_Price_Prediction_Module_&_Data_Visualization\\Annual House Transaction Volume.png', dpi=100)
plt.show()